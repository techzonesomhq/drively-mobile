...
class CountryPickerDialog extends StatefulWidget {
  final List<AppIntlCountry> countryList;
  final AppIntlCountry selectedCountry;
  final ValueChanged<AppIntlCountry> onCountryChanged;
  final String searchText;
  final List<AppIntlCountry> filteredCountries;
...
class _CountryPickerDialogState extends State<CountryPickerDialog> {
  late List<AppIntlCountry> _filteredCountries;
