...
class _IntlPhoneFieldState extends State<IntlPhoneField> {
  late List<AppIntlCountry> _countryList;
  late AppIntlCountry _selectedCountry;
  late List<AppIntlCountry> filteredCountries;
  late String number;
  ...
  void initState() {
    ...
    if (widget.initialCountryCode == null && number.startsWith('+')) {
      ...
      // parse initial value
      _selectedCountry = intlCountriesList.firstWhere((country) => number.startsWith(country.fullCountryCode), orElse: () => _countryList.first);
    ...
    await showDialog(
      ...
      builder: (context) => StatefulBuilder(
        builder: (ctx, setState) => CountryPickerDialog(
          ...
          onCountryChanged: (AppIntlCountry country) {
